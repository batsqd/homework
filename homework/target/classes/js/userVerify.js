$(document).ready(function(){
    ...
    $("#login-button").click(function(){
        ...
        if(nickName==""|password==""){
            ...
            $.ajax({
                type:'POST',
                url:'http://localhost:8080/homework/loginValidation.action',
                ...
                success:function(data){
                    if(data.nickname==null){
                        ...
                        //进入主页面
                        window.location.href = "http://localhost:8080/homework/getHomePageCommodity.action";
                    }
                }
            });
        }
    ...
    $("#register").click(function(){
        ...
        if(username_register==""|| password_register==""|| password_register_again==""){
            ...
            $.ajax({
                type:'POST',
                url:'http://localhost:8080/homework/register.action',
